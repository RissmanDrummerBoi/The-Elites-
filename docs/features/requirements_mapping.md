...
Students must be able to fill in and submit a complaint form.
The system must categorize complaints based on type (e.g., plumbing, electrical).

Non-Functional Requirements:
The system should allow quick submission without delays.
...
Non-Functional Requirements:
Status updates should reflect in real-time or near real-time.
...
User accounts must be protected from unauthorized access.
